    ...
    <div id="app">
      ...
      >
        <div class="justify-between items-center block md:flex">
          ...
          <div class="flex shrink-0 grow-0 items-center justify-center">
            <button
              class="inline-flex cursor-pointer justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border rounded ring-blue-700 p-2 bg-white text-black border-gray-300 hover:bg-gray-50"
              type="button"
            >
      ...
      <section class="px-0 md:px-6 py-6">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6">
          <div
            class="md:rounded border-gray-100 dark:bg-gray-900/70 bg-white border dark:border-gray-800 shadow"
          >
            <!--v-if-->
            <div class="p-6">
                ...
                <div class="justify-between items-center block md:flex">
                  ...
                  >
                    <div class="justify-start items-center block md:flex">
                      ...
                      >
                        <span
                          class="inline-flex justify-center items-center w-12 h-12 rounded-full text-emerald-600 bg-gray-100 dark:bg-gray-800 md:mr-6"
                          ><svg
                            viewBox="0 0 24 24"
                            width="24"
                            height="24"
                ...
                <div class="justify-between items-center block md:flex">
                  ...
                  >
                    <div class="justify-start items-center block md:flex">
                      ...
                      >
                        <span
                          class="inline-flex justify-center items-center w-12 h-12 rounded-full text-blue-600 bg-gray-100 dark:bg-gray-800 md:mr-6"
                          ><svg
                            viewBox="0 0 24 24"
                            width="24"
                            height="24"
                ...
                <div class="justify-between items-center block md:flex">
                  ...
                  >
                    <div class="justify-start items-center block md:flex">
                      ...
                      >
                        <span
                          class="inline-flex justify-center items-center w-12 h-12 rounded-full text-yellow-600 bg-gray-100 dark:bg-gray-800 md:mr-6"
                          ><svg
                            viewBox="0 0 24 24"
                            width="24"
                            height="24"
        ...
        <div
          class="md:rounded border-gray-100 dark:bg-gray-900/70 bg-white border dark:border-gray-800"
        >
          <header
            class="border-gray-100 flex items-stretch border-b dark:border-gray-800"
          >
          ...
          <div class="">
            <div
              class="flex items-center flex-col justify-center overflow-hidden fixed inset-0 z-50"
              style="display: none"
            >
              <div
              ...
              ></div>
              <div
                class="rounded-lg border-gray-100 dark:bg-gray-900 bg-white border dark:border-gray-800 shadow-lg w-full max-h-modal md:w-3/5 lg:w-2/5 z-50"
                style="display: none"
              >
                <header
                  class="border-gray-100 flex items-stretch border-b dark:border-gray-800"
              ...
              <tbody>
                ...
                <tr class="lg:hover:bg-gray-100">
                  ...
                  <td class="image-cell">
                    <div class="image">
                      <img
                        src="https://avatars.dicebear.com/api/avataaars/Adrienne-Mayer III.svg"
                ...
                <tr class="lg:hover:bg-gray-100 lg:bg-gray-50">
                  ...
                  <td class="image-cell">
                    <div class="image">
                      <img
                        src="https://avatars.dicebear.com/api/avataaars/Mr-Julien Ebert.svg"
                        alt="Mr. Julien Ebert"
                        class="rounded-full block h-auto w-full max-w-full dark:bg-gray-800 bg-gray-100"
                      />
                    </div>
                ...
                <tr class="lg:hover:bg-gray-100">
                  ...
                  <td class="image-cell">
                    <div class="image">
                      <img
                        src="https://avatars.dicebear.com/api/avataaars/Lenna-Smitham.svg"
                        alt="Lenna Smitham"
                        class="rounded-full block h-auto w-full max-w-full dark:bg-gray-800 bg-gray-100"
                      />
                    </div>
                ...
                <tr class="lg:hover:bg-gray-100 lg:bg-gray-50">
                  ...
                  <td class="image-cell">
                    <div class="image">
                      <img
                        src="https://avatars.dicebear.com/api/avataaars/Travis-Davis.svg"
                        alt="Travis Davis"
                        class="rounded-full block h-auto w-full max-w-full dark:bg-gray-800 bg-gray-100"
                      />
                    </div>
                ...
                <tr class="lg:hover:bg-gray-100">
                  ...
                  <td class="image-cell">
                    <div class="image">
                      <img
                        src="https://avatars.dicebear.com/api/avataaars/Prof-Esteban Steuber.svg"
            ...
            <div
              class="border-gray-100 p-3 lg:px-6 border-t dark:border-gray-800"
            >
              <div class="justify-between items-center block md:flex">
                <div
                  class="flex shrink-0 grow-0 items-center justify-center mb-6 md:mb-0"
                >
                  <div class="flex items-center justify-start flex-wrap -mb-3">
                    <button
                      ...
                      type="button"
                    >
                      <!--v-if--><span class="px-2">1</span></button
                    ><button
